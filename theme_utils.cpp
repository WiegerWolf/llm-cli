...
void applyWhiteTheme() {
    ...
    colors[ImGuiCol_Border] = ImVec4(0.74f, 0.74f, 0.74f, 0.50f);
    colors[ImGuiCol_BorderShadow] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
...
ImU32 ThemeUtils::GetThemeNodeColor(ThemeType theme) {
    switch (theme) {
        case ThemeType::DARK:
            return IM_COL32(45, 45, 50, 255);
        case ThemeType::WHITE:
...
ImU32 ThemeUtils::GetThemeNodeBorderColor(ThemeType theme) {
    switch (theme) {
        case ThemeType::DARK:
            return IM_COL32(80, 80, 85, 255);
        case ThemeType::WHITE:
            return IM_COL32(180, 180, 185, 255);
        default:
            return IM_COL32(100, 100, 100, 255);
    }
}

ImU32 ThemeUtils::GetThemeNodeSelectedBorderColor(ThemeType theme) {
    switch (theme) {
        case ThemeType::DARK:
...
ImU32 ThemeUtils::GetThemeEdgeColor(ThemeType theme) {
    switch (theme) {
        case ThemeType::DARK:
            return IM_COL32(120, 120, 125, 255);
        case ThemeType::WHITE:
            return IM_COL32(100, 100, 105, 255);
        default:
            return IM_COL32(150, 150, 150, 255);
    }
}

ImU32 ThemeUtils::GetThemeBackgroundColor(ThemeType theme) {
    switch (theme) {
        case ThemeType::DARK:
            return IM_COL32(25, 25, 30, 255);
        case ThemeType::WHITE:
            return IM_COL32(250, 250, 255, 255);
        default:
            return IM_COL32(30, 30, 40, 255);
    }
}

ImU32 ThemeUtils::GetThemeTextColor(ThemeType theme) {
    switch (theme) {
        case ThemeType::DARK:
            return IM_COL32(220, 220, 225, 255);
        case ThemeType::WHITE:
...
ImU32 ThemeUtils::GetThemeExpandCollapseIconColor(ThemeType theme) {
    switch (theme) {
        case ThemeType::DARK:
            return IM_COL32(180, 180, 185, 255);
        case ThemeType::WHITE:
