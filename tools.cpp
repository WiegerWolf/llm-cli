...
std::string ToolManager::search_web(const std::string& query) {
    ...
    // headers = curl_slist_append(headers, "Accept: text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,*/*;q=0.8"); // Remove Accept header
    // headers = curl_slist_append(headers, "Accept-Language: en-US,en;q=0.5"); // Remove Accept-Language header
