...
enum class ThemeType { DARK, WHITE };
// --- End Theme Type Enum ---
...
private:
  ...
  void enqueueDisplayMessage(MessageType type, const std::string &content,
  ...
  mutable std::mutex
      models_ui_mutex; // To protect available_models_for_ui and current_selected_model_id_in_ui
